...
# Author: Marcus D. Leec (patchvonbraun), Science Radio Laboratories, Inc
# Description: Six channel SID receiver, use with audio I/O
# Generated: Wed Aug  7 17:37:46 2013
##################################################
...
class audioSIDnetRcvr(grc_wxgui.top_block_gui):
	...
	def __init__(self, f4=18.5e3, f3=22.5e3, f2=19.50e3, f1=24.0e3, f5=19.5e3, f6=14.5e3, hz=60, samp_rate=96000, integ=5.0, igain=1, audio_shift=23.0e3, audio_width=6.0e3, synoptic_length=int(100e3), cfn="/dev/null", synoptic_ratio=10, ohwname="hw:1,0", hwname="hw:0,0"):
		...
		self.strip_out_rate = strip_out_rate = 1.0/5.0
		...
		self.xmlrpc_server_0 = SimpleXMLRPCServer.SimpleXMLRPCServer(("localhost", 8977), allow_none=True)
		...
		self.gr_keep_one_in_n_0_0_0_0_1_0_0_0_1 = gr.keep_one_in_n(gr.sizeof_float*1, int(cbw/strip_out_rate))
		self.gr_keep_one_in_n_0_0_0_0_1_0_0_0_0 = gr.keep_one_in_n(gr.sizeof_float*1, int(cbw/strip_out_rate))
		self.gr_keep_one_in_n_0_0_0_0_1_0_0_0 = gr.keep_one_in_n(gr.sizeof_float*1, int(cbw/strip_out_rate))
		self.gr_keep_one_in_n_0_0_0_0_1_0_0 = gr.keep_one_in_n(gr.sizeof_float*1, int(cbw/strip_out_rate))
		self.gr_keep_one_in_n_0_0_0_0_1_0 = gr.keep_one_in_n(gr.sizeof_float*1, int(cbw/strip_out_rate))
		self.gr_keep_one_in_n_0_0_0_0_1 = gr.keep_one_in_n(gr.sizeof_float*1, int(cbw/strip_out_rate))
		...
		self.gr_fft_filter_xxx_0 = gr.fft_filter_ccc(1, (notchfilt.notch_taps(samp_rate,hz,(samp_rate/2)/hz)), 1)
	...
	def get_strip_out_rate(self):
		return self.strip_out_rate

	def set_strip_out_rate(self, strip_out_rate):
		self.strip_out_rate = strip_out_rate
		self.gr_keep_one_in_n_0_0_0_0_1.set_n(int(self.cbw/self.strip_out_rate))
		self.gr_keep_one_in_n_0_0_0_0_1_0.set_n(int(self.cbw/self.strip_out_rate))
		self.gr_keep_one_in_n_0_0_0_0_1_0_0.set_n(int(self.cbw/self.strip_out_rate))
		self.gr_keep_one_in_n_0_0_0_0_1_0_0_0.set_n(int(self.cbw/self.strip_out_rate))
		self.gr_keep_one_in_n_0_0_0_0_1_0_0_0_0.set_n(int(self.cbw/self.strip_out_rate))
		self.gr_keep_one_in_n_0_0_0_0_1_0_0_0_1.set_n(int(self.cbw/self.strip_out_rate))
		self.MyScopeSink.set_sample_rate(self.strip_out_rate)
...
if __name__ == '__main__':
	...
	tb = audioSIDnetRcvr(f4=options.f4, f3=options.f3, f2=options.f2, f1=options.f1, f5=options.f5, f6=options.f6, hz=options.hz, samp_rate=options.samp_rate, integ=options.integ, igain=options.igain, audio_shift=options.audio_shift, audio_width=options.audio_width, synoptic_length=options.synoptic_length, cfn=options.cfn, synoptic_ratio=options.synoptic_ratio, ohwname=options.ohwname, hwname=options.hwname)
	tb.Run(True)

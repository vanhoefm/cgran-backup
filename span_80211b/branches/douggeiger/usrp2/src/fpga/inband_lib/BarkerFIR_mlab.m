...
%-----------------------------------------------------------------------------------------------------------
	...
	function  output = BarkerFIR_mlab_mat (stimulation, output)
	coef_matrix=[64 35 -18 -62 -67 -23 51 112 127 86 11 -50 -70 -44 7 51 71 70 64 67 76 77 55 13 -35 -69 -81 -74 -64 -61 -64 -64 ];
	INTER_FACTOR  = 1;
	DECI_FACTOR  = 1; 
	MSB_RM  = 0;
	MSB_TYPE  = 1;

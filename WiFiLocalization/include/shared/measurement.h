...
public:
  /// These need to be public for path loss models' functions
  ...
  bool sanityCheck(void); //Helper for measbuilder, sanity checks the measurement
  ...
  vector<Location*> getLocations(void); //Returns the locations from each packet O(# sensors)
  MacAddr* getMac(void); ///Avoid use: See note in .cpp file
